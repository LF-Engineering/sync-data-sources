...
# git clone "https://github.com/AlDanial/cloc.git" --branch "v1.90" --single-branch || exit 17
...
# cd grimoirelab-elk && git fetch origin pull/906/head:reactions && git checkout reactions && git rebase "master" && cd .. || exit 24
...
# cd grimoirelab-perceval && git apply --ignore-space-change --ignore-whitespace ../../patch/perceval-dependency-fixes.py.diff && cd .. || exit 28
...
# cd grimoirelab-elk && git apply --ignore-space-change --ignore-whitespace ../../patch/elk-dependency-fixes.py.diff && cd .. || exit 29
