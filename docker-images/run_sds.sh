...
envstr="-e BRANCH=\"${e}\""
for renv in SH_USER SH_HOST SH_PORT SH_PASS SH_DB SDS_ES_URL SDS_GITHUB_OAUTH AUTH0_URL AUTH0_AUDIENCE AUTH0_CLIENT_ID AUTH0_CLIENT_SECRET AFFILIATION_API_URL AUTH0_DATA METRICS_API_URL REPO_ACCESS AUTH0_GRANT_TYPE ES_CACHE_PASSWORD ES_CACHE_URL ES_CACHE_USERNAME GAP_URL
do
