...
envstr="-e BRANCH=\"$1\""
for renv in SDS_SSAW_URL SH_USER SH_HOST SH_PORT SH_PASS SH_DB SDS_ES_URL SDS_GITHUB_OAUTH AUTH0_URL AUTH0_AUDIENCE AUTH0_CLIENT_ID AUTH0_CLIENT_SECRET REPO_ACCESS
do
