...
envlist='SDS_ROLE_ARN SDS_FS_ID SDS_TASK_NAME SDS_SSAW_URL SDS_SH_USER SDS_SH_HOST SDS_SH_PORT SDS_SH_PASS SDS_SH_DB SDS_ES_URL SDS_GITHUB_OAUTH SDS_AUTH0_DATA SDS_AFFILIATION_API_URL SDS_METRICS_API_URL SDS_AUTH0_URL SDS_AUTH0_AUDIENCE SDS_AUTH0_CLIENT_ID SDS_AUTH0_CLIENT_SECRET SDS_ZIPPASS SDS_REPO_ACCESS'
if [ ! -z "${AP}" ]
then
