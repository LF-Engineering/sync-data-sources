...
export SDS_BRANCH="${1}"
for renv in SDS_ROLE_ARN SDS_FS_ID SDS_TASK_NAME SDS_SSAW_URL SDS_SH_USER SDS_SH_HOST SDS_SH_PORT SDS_SH_PASS SDS_SH_DB SDS_ES_URL SDS_GITHUB_OAUTH SDS_ZIPPASS SDS_REPO_ACCESS
do
  if [ -z "${!renv}" ]
  then
