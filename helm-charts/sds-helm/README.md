...
- If not installed with the Helm chart (hich is the default), for the `test` env do: `./debug test`, `pod_shell.sh test sds sds-debug-0` to get a shell inside `sds` deployment.
