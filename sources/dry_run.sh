#!/bin/bash
# Example: SH_HOST=127.0.0.1 SH_PORT=13306 SH_DB=sortinghat SH_USER=sortinghat SH_PASS=pwd GAP_URL=http://127.0.0.1:8200 RETRIES=3 DELAY=2s ./dry_run.sh test
if [ -z "$1" ]
then
...
export ES_CACHE_URL=""
export ES_CACHE_USERNAME=""
export ES_CACHE_PASSWORD=""
export ENVIRONMENT=""
...
export SDS_DRY_RUN_ALLOW_F_ALIASES=1
