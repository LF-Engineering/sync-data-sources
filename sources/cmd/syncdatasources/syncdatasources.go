...
var (
	...
	dadsTasks = map[string]bool{lib.Jira: false, lib.GroupsIO: false, lib.Git: false, lib.Gerrit: false, lib.Confluence: false, lib.RocketChat: false, lib.DockerHub: true, lib.Bugzilla: true, lib.BugzillaRest: true, lib.Jenkins: false}
